...
const data = (begin_date: number, end_date: number) =>
  `fields *,game.*,game.screenshots.*; where category = 0 & game.category = (0, 8, 9, 11) & region = (2, 8) & date >= ${begin_date} & date <= ${end_date} & game.platforms = (167, 49, 167, 130, 169) & game.themes != (42) & game.version_parent = null; limit 500;`;
